          ...
          <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as 'active' | 'minor' | 'pending')}>
            ...
            <TabsContent value="minor">
              {minorIssueBusinesses.length === 0 ? (
                <Card className="shadow-card">
                  <CardContent className="py-16 text-center">
                    <p className="text-muted-foreground">No minor issues found. All optional fields are valid.</p>
                  </CardContent>
                </Card>
              ) : (
                <>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-xs text-amber-700">
                            These locations have non-critical validation issues in optional fields (e.g. URL format, phone format). They will be excluded from export until fixed. Click the exclamation mark to see details.
                          </p>
                        </div>
                      </div>
                    </CardContent>
